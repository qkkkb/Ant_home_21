...
from lsm6dsv16x_v3 import LSM6DSV16X_V3
...
class LSM6DSV16XYawRuntime:
    """
    LSM6DSV16X SPI IMU runtime, keeping the old main.py yaw/gyro interface.
    The new driver returns gyro values in dps, so scale defaults to -1.0.
    """
    ...
    def __init__(
        ...
        self.imu = LSM6DSV16X_V3(gyro_fs=gyro_fs, accel_fs=accel_fs)
    ...
    @staticmethod
    def help():
        print("LSM6DSV16X_V3 SPI gyro runtime: get_gyro()[2] -> yaw-rate")
