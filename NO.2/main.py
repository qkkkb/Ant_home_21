...
Follow_Distance_Close_Gain = 0.50
Follow_Distance_Close_Limit = 14.0
Follow_Distance_Emergency_Close_Error = 32
Follow_Orbit_Close_Guard_Error = 6
Follow_Orbit_Close_Back_Max_Vx = 18.0
Follow_Orbit_Close_Back_Gain = 1.35
Follow_Orbit_Close_Full_Error = 10
Follow_Orbit_Close_Vy_Limit = 12.5
...
Follow_Push_Feedforward_Forward_Gain = 3.20
...
Follow_Push_Feedforward_Fade_Error = 6
...
Follow_Orbit_Target_Point_Wz_To_Vy = -0.42
Follow_Orbit_Feedforward_Forward_Gain = 1.30
Follow_Orbit_Feedforward_Lateral_Gain = 0.85
Follow_Orbit_Feedforward_Forward_Limit = 28.0
Follow_Orbit_Feedforward_Lateral_Limit = 24.0
...
Follow_Orbit_Close_Feedforward_Min_Scale = 0.08
...
Follow_Orbit_Pose_Angle_Min_Error = 18
Follow_Orbit_Pose_Angle_Min_Turn = 24.0
...
Follow_Spin_Command_Ramp_Wz = 42.0
...
def update_follow_targets(yaw_deg, gyro_z):
    ...
    if seen:
        ...
        orbit_close_guard_active = (
            ...
            and cam_error_y <= -Follow_Orbit_Close_Guard_Error
        )
