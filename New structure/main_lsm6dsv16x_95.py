...
Nav_Low_Speed_Th = 30
Nav_Coarse_Forward_Gain = 0.085
Nav_Coarse_Lateral_Gain = 0.040		#COARSE 横移系数
Nav_Coarse_Forward_Limit = 7.6
Nav_Coarse_Lateral_Limit = 4.8
Nav_Fine_Forward_Gain = 0.040
Nav_Fine_Classify_Lateral_Gain = 0.070
Nav_Fine_Lateral_Gain = 0.135        #FINE 横移系数
Nav_Fine_Push_Lateral_Gain = 0.075
Nav_Fine_Forward_Limit = 5.0
Nav_Fine_Lateral_Limit = 5.8
Nav_Fine_Push_Lateral_Limit = 3.3
...
Nav_Push_Orbit_Fast_Vy = 3.7
Nav_Push_Orbit_Fast_Rate = 110.0
Nav_Push_Orbit_Slow_Rate = 48.0
...
Nav_Push_Prepare_Forward_Limit = 4.3
Nav_Push_Prepare_Lateral_Limit = 6.0
Nav_Push_Prepare_Min_Vx = 1.8
Nav_Push_Prepare_Min_Vy = 3.5
Nav_Push_Prepare_Kick_X = 18
Nav_Push_Prepare_Kick_Vy = 5.8
Nav_Push_Prepare_Lateral_Brake_Ms = 70
Nav_Push_Prepare_Lateral_Brake_Speed = 5.0
Nav_Push_Prepare_Back_Ms = 90
Nav_Push_Prepare_Back_Speed = 4.8
...
Nav_Post_Turn_Forward_Speed = 10.5
