...
Nav_Low_Speed_Th = 30
Nav_Coarse_Forward_Gain = 0.125
Nav_Coarse_Lateral_Gain = 0.060		#COARSE 横移系数
Nav_Coarse_Forward_Limit = 13.0
Nav_Coarse_Lateral_Limit = 8.2
Nav_Fine_Forward_Gain = 0.065
Nav_Fine_Classify_Lateral_Gain = 0.110
Nav_Fine_Lateral_Gain = 0.190        #FINE 横移系数
Nav_Fine_Push_Lateral_Gain = 0.115
Nav_Fine_Forward_Limit = 8.2
Nav_Fine_Lateral_Limit = 9.2
Nav_Fine_Push_Lateral_Limit = 5.6
...
Nav_Push_Orbit_Fast_Vy = 6.8
Nav_Push_Orbit_Slow_Vy = 5.2
...
Nav_Push_Execute_Forward_Speed = 12.0    #执行阶段前进速度
Nav_Push_Execute_Gyro_Limit = 14.0
