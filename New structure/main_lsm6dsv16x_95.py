...
Nav_Low_Speed_Th = 30
Nav_Coarse_Forward_Gain = 0.105
Nav_Coarse_Lateral_Gain = 0.052		#COARSE 横移系数
Nav_Coarse_Forward_Limit = 10.5
Nav_Coarse_Lateral_Limit = 6.8
Nav_Fine_Forward_Gain = 0.052
Nav_Fine_Classify_Lateral_Gain = 0.090
Nav_Fine_Lateral_Gain = 0.165        #FINE 横移系数
Nav_Fine_Push_Lateral_Gain = 0.095
Nav_Fine_Forward_Limit = 6.8
Nav_Fine_Lateral_Limit = 7.8
Nav_Fine_Push_Lateral_Limit = 4.5
...
Nav_Push_Orbit_Fast_Vy = 5.0
Nav_Push_Orbit_Fast_Rate = 125.0
Nav_Push_Orbit_Slow_Rate = 65.0
Nav_Push_Orbit_Gyro_Limit = 20.0
Nav_Push_Orbit_Radius_Base = 1.55   #orbit 基础半径系数，实际轨迹半径=该系数 * 车轮轴距；如果轨迹过大或过小可以调整该值
Nav_Push_Orbit_Radius_Gain = 0.006
